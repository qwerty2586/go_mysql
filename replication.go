...
type (
	...
	Slave struct {
		...
		MasterAutoPosition        bool     `json:"master_auto_position" db:"master_auto_position"`
		RelayLogFile              string   `json:"relay_log_file" db:"relay_log_file"`
		RelayLogPos               uint64   `json:"relay_log_pos" db:"relay_log_pos"`
		MasterSSL                 bool     `json:"master_ssl" db:"master_ssl"`
		...
		MasterSSLVerifyServerCert bool     `json:"master_ssl_verify_server_cert" db:"master_ssl_verify_server_cert"`
